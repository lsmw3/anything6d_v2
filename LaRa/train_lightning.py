...
def main(cfg, specs):
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename='pcd_render_{epoch}',        # Filename for the checkpoints
        monitor='val loss',
        save_last=True,
        save_top_k=1,             # Set to -1 to save all checkpoints
        every_n_epochs=50,          # Save a checkpoint every K epochs
    ...
    # trainer.save_checkpoint(cfg.model.ckpt_path)
    # print(f"checkpoint saved at: {cfg.model.ckpt_path}")
...
if __name__ == '__main__':
    ...
    with open('configs/specs.json', 'r') as f:
        specs = json.load(f)
