...
CO3D_RAW_ROOT = '/mnt/hdd/lara_data/dataset/Co3D' # change to where your CO3D data resides
CO3D_OUT_ROOT = '/mnt/hdd/lara_data/dataset/Co3D' # change to your folder here
...
if __name__ == "__main__":
    for category in ["hotdog"]: #"teddybear", "hydrant"
